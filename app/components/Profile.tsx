...
const AddFriendModal: React.FC<{
    ...
    setFriends: React.Dispatch<React.SetStateAction<Friend[]>>;
    onClose: () => void;
}> = ({ profile, friends, setFriends, onClose }) => {
...
const ProfileModal: React.FC<ProfileModalProps> = ({ profile, setProfile, friends, setFriends, onClose, onLogout }) => {
  ...
  return (
    ...
    {isAddFriendOpen && <AddFriendModal profile={profile} friends={friends} setFriends={setFriends} onClose={() => setIsAddFriendOpen(false)} />}
    </>
  );
};
